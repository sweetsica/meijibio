...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $users = [
            ...
            ['getfly_id'=>1,'area'=>'Toàn quốc','code'=>'MJB00028','name'=>'Nguyễn Thúy An','title'=>'Giám đốc tài chính (CFO)','email'=>'annguyen.namviet@gmail.com','username'=>'taichinhkt','department'=>null,'team'=>'Phòng vận hành','role'=>'moderator','password'=>Hash::make('CRMmeijibio2025@#!'),'status'=>1],
            ...
            ['getfly_id'=>20,'area'=>'HCM','code'=>'MJB00048','name'=>'Trần Nguyễn Kim Ngân','title'=>'Giám đốc chi nhánh (DM)','email'=>'Jennytran@meijibio.com','username'=>'Jennytran@meijibio.com','department'=>'Phòng TC - KT','team'=>'Ban giám đốc','role'=>'sale_manager','password'=>Hash::make('Meijibio2025@#!'),'status'=>1],
            ['getfly_id'=>22,'area'=>'HCM','code'=>'MJB00057','name'=>'Phan Trần Khánh Quỳnh','title'=>'Team Leader (TL)','email'=>'phantrankhanhquynh1211@gmail.com','username'=>'phantrankhanhquynh1211@gmail.com','department'=>null,'team'=>'Đội kinh doanh HCM 1','role'=>'sale_manager','password'=>Hash::make('Meijibio2025@#!'),'status'=>1],
            ...
            ['getfly_id'=>38,'area'=>'HCM','code'=>'MJB00094','name'=>'Lê Thị Thảo Nguyên','title'=>'Nhân viên Admin','email'=>'thaonguyen.kangenktb@gmail.com','username'=>'thaonguyen.kangenktb@gmail.com','department'=>'Check sd tk mail cty','team'=>null,'role'=>'moderator','password'=>Hash::make('Meijibio2025@#!'),'status'=>1],
            ['getfly_id'=>39,'area'=>'HCM','code'=>'MJB00086','name'=>'Nguyễn Thị Dung','title'=>'Nhân viên Admin','email'=>'Nguyenthidungg25082001@gmail.com','username'=>'Nguyenthidungg25082001@gmail.com','department'=>'Check sd tk mail cty','team'=>null,'role'=>'moderator','password'=>Hash::make('Meijibio2025@#!'),'status'=>1],
            ...
            ['getfly_id'=>42,'area'=>'HCM','code'=>null,'name'=>'Phan Thị Thanh Tú','title'=>'Trực page','email'=>'thanhtu140800@gmail.com','username'=>'thanhtu140800@gmail.com','department'=>null,'team'=>null,'role'=>'cskh','password'=>Hash::make('Meijibio2025@#!'),'status'=>1],
        ];
